const payload = {
  ...
  check_run: {
    ...
    output: {
      ...
      annotations_count: 0,
      annotations_url:
        'https://api.github.com/repos/Codertocat/Hello-World/check-runs/128620228/annotations',
    },
    ...
    check_suite: {
      ...
      pull_requests: [
        ...
        {
          url: 'https://api.github.com/repos/getsentry/sentry/pulls/2',
          id: 279147438,
          number: 3,
          head: {
            ref: 'changes',
            sha: 'ec26c3e57ca3a959ca5aad62de7213c562f8c822',
            repo: {
              id: 186853003,
          ...
          base: {
            ref: 'master',
            sha: 'f95f852bd8fca8fcc58a9a2d6c842781e32a215f',
            repo: {
              id: 186853003,
              url: 'https://api.github.com/repos/getsentry/sentry',
              name: 'Hello-World',
      ...
      app: {
        ...
        owner: {
          ...
          following_url:
            'https://api.github.com/users/Octocoders/following{/other_user}',
          gists_url: 'https://api.github.com/users/Octocoders/gists{/gist_id}',
          starred_url:
            'https://api.github.com/users/Octocoders/starred{/owner}{/repo}',
          subscriptions_url:
            'https://api.github.com/users/Octocoders/subscriptions',
          organizations_url: 'https://api.github.com/users/Octocoders/orgs',
          repos_url: 'https://api.github.com/users/Octocoders/repos',
          events_url:
            'https://api.github.com/users/Octocoders/events{/privacy}',
          received_events_url:
            'https://api.github.com/users/Octocoders/received_events',
          type: 'Organization',
          site_admin: false,
        },
        name: 'octocoders-linter',
