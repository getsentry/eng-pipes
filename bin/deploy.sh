...
env_vars+=GH_APP_IDENTIFIER="${GH_APP_IDENTIFIER}",
env_vars+=GH_APP_SECRET_KEY="${GH_APP_SECRET_KEY}",
env_vars+=GH_WEBHOOK_SECRET="${GH_WEBHOOK_SECRET}",
env_vars+=VERSION="${VERSION}",
env_vars+=SENTRY_WEBPACK_WEBHOOK_SECRET="${SENTRY_WEBPACK_WEBHOOK_SECRET}",
