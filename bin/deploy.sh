...
env_vars="${env_vars}GITHUB_USER_DIRECTORY_BQ_DATASET=${GITHUB_USER_DIRECTORY_BQ_DATASET},"
env_vars="${env_vars}GITHUB_USER_DIRECTORY_BQ_TABLE=${GITHUB_USER_DIRECTORY_BQ_TABLE},"
