...
import testAdminPayload from '@test/payloads/generic-notifier/testAdminPayload.json';
import testBadPayload from '@test/payloads/generic-notifier/testBadPayload.json';
import testMegaPayload from '@test/payloads/generic-notifier/testMegaPayload.json';
