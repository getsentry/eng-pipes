...
import testBadPayload from '@test/payloads/status-page/testBadPayload.json';
import testMegaPayload from '@test/payloads/status-page/testMegaPayload.json';
import testPayload from '@test/payloads/status-page/testPayload.json';
...
describe('status-page webhook', function () {
  let fastify;
  ...
  it('correctly inserts status-page webhook when stage starts', async function () {
